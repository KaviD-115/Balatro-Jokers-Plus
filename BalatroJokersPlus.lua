...
SMODS.Atlas({ 
    key = "jokersplusupdatepack2026",
    path = "jokersplusupdatepack2026.png", 
    px = 71,
    py = 95,
})
...
SMODS.Joker{
  ...
  loc_txt = {
    ...
    rarity = 1,
    atlas = "jokersplusupdatepack2026", pos = {x = 0, y = 0},
    cost = 5,
    unlocked = true,
    discovered = true,
    eternal_compat = true,
...
SMODS.Joker{
  ...
  loc_txt = {
    ...
    rarity = 2,
    atlas = "jokersplusupdatepack2026", pos = {x = 2, y = 0},
    cost = 6,
    unlocked = true,
    discovered = true,
    eternal_compat = false,
...
SMODS.Joker{
  ...
  loc_txt = {
    ...
    rarity = 1,
    atlas = "jokersplusupdatepack2026", pos = {x = 4, y = 0},
    cost = 5,
    unlocked = true,
    discovered = true,
    eternal_compat = true,
...
SMODS.Joker{
  ...
  loc_txt = {
    ...
    rarity = 1,
    atlas = "jokersplusupdatepack2026", pos = {x = 1, y = 0},
    cost = 5,
    unlocked = true,
    discovered = true,
    eternal_compat = true,
...
SMODS.Joker{
  ...
  loc_txt = {
    ...
    rarity = 1,
    atlas = "jokersplusupdatepack2026", pos = {x = 5, y = 0},
    cost = 5,
    unlocked = true,
    discovered = true,
    eternal_compat = true,
...
SMODS.Joker{
  ...
  loc_txt = {
    ...
    rarity = 2,
    atlas = "jokersplusupdatepack2026", pos = {x = 3, y = 0},
    cost = 6,
    unlocked = true,
    discovered = true,
    eternal_compat = true,
...
SMODS.Challenge{
    ...
    jokers = {
        ...
        {id = 'j_PlusJokers_excitebike', eternal = true},
    },
    consumeables = {},
    vouchers = {
},
...
SMODS.Challenge{
    loc_txt = "Glowing Green Balls (BJ+)",
    key = 'greenballs',
    rules = {
        custom = {
},
    ...
    jokers = {
        {id = 'j_PlusJokers_raygun', eternal = true},
...
SMODS.Challenge{
    ...
    jokers = {
        {id = 'j_PlusJokers_cuphead', eternal = true},
